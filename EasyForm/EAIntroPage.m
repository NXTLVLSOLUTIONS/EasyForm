...
#define DEFAULT_TITLE_FONT [UIFont fontWithName:@"HelveticaNeue-Bold" size:19.0]
#define DEFAULT_LABEL_COLOR [UIColor blackColor]
#define DEFAULT_BG_COLOR [UIColor clearColor]
#define DEFAULT_DESCRIPTION_FONT [UIFont fontWithName:@"HelveticaNeue-Light" size:17.0]
#define DEFAULT_TITLE_IMAGE_Y_POSITION 50.0f
#define DEFAULT_TITLE_LABEL_Y_POSITION 250.0f
#define DEFAULT_DESCRIPTION_LABEL_Y_POSITION 180.0f
#define DEFAULT_DESCRIPTION_LABEL_SIDE_MARGIN 40.0f
