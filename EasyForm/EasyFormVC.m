...
@interface EasyFormVC ()<FancyTabBarDelegate,GMSAutocompleteTableDataSourceDelegate, GMSAutocompleteViewControllerDelegate, GMSAutocompleteResultsViewControllerDelegate,UITextFieldDelegate,AWNavigationMenuItemDataSource, AWNavigationMenuItemDelegate,UICollectionViewDelegateFlowLayout>
...
//    self.menuLeft.delegate   = self;
    ...
    NSArray *images = @[[UIImage imageNamed:@"Doctors"],
                        [UIImage imageNamed:@"Dentists"],
                        [UIImage imageNamed:@"Chiro"],
//                        [UIImage imageNamed:@"Business"],
                        [UIImage imageNamed:@"Real Estate"],
                        [UIImage imageNamed:@"Lawyers"]];
    
    NSArray *selectedImages =@[[UIImage imageNamed:@"Doctors"],
                               [UIImage imageNamed:@"Dentists"],
                               [UIImage imageNamed:@"Chiro"],
//                               [UIImage imageNamed:@"Business"],
                               [UIImage imageNamed:@"Real Estate"],
    ...
    segmentedControl2.frame = CGRectMake(0, self.navigationController.navigationBar.frame.size.height, viewWidth, 150);
    ...
    segmentedControl2.selectionIndicatorColor = [UIColor colorWithRed:0.00 green:0.48 blue:1.00 alpha:1.0];
...
//        isMenuEnabled = YES;
        ...
        if ( UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad )
        {
            ...
            postingCell.layer.borderWidth=0.5f;
...
//    }
    ...
    if ( UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad )
    {
        CGFloat viewWidth = (CGRectGetWidth(collectionView.frame)-2)/4;
        return CGSizeMake(viewWidth, 230);

    }else{
        CGFloat viewWidth = (CGRectGetWidth(collectionView.frame)-2)/2;
        return CGSizeMake(viewWidth, 230);
    }
...
- (void)segmentedControlChangedValue:(HMSegmentedControl *)segmentedControl {
    ...
    switch (segmentedControl.selectedSegmentIndex) {
        ...
        case 2:
            [[ParseDataFormatter sharedInstance] queryProviderType:CHIROPRACTOR];
            self.title = [CHIROPRACTOR uppercaseString];
            [[NSUserDefaults standardUserDefaults] setObject:@"chiropractor" forKey:@"fancyType"];
            [[NSUserDefaults standardUserDefaults] synchronize];
            break;
...
- (IBAction)Profile:(id)sender {
    ...
    UIViewController *vc = [sb instantiateViewControllerWithIdentifier:@"SettingsNav"];
